...
public class ActivityAltas extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cajaNumControl = findViewById(R.id.caja_nombre_producto);
        cajaNombre = findViewById(R.id.caja_cantidad);
    ...
    public void agregarAlumno(View v){
        ...
        if(network != null && cm.getNetworkCapabilities(cm.getActiveNetwork()) != null ){
            ...
            new Thread(new Runnable() {
                @Override
                public void run() {
                    String url = "http://10.0.2.2/ProyectoPagina/ApI_REST_MySQL/api_altas.php";
                    String metodo = "POST";
